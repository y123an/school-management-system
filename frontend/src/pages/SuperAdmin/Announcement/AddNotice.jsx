...
const AddNotice = () => {
  ...
  const fields = { title, details, date, recipient, adminID };
        ...
        <div className="flex flex-1">
          ...
          <div className="flex-1 flex justify-center items-center bg-gray-100">
            ...
            >
              ...
              <button
                className={`w-full py-2 px-4 bg-green-500 text-white font-semibold rounded-lg shadow-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-400 ${
